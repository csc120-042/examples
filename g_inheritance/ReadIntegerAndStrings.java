...
/*
 * class ReadIntegerAndStrings
 * burton rosenberg
 * march 2004
 * (based in earily ReadInteger class)
 *
 * an ad-hoc class for reading integers and srings from console
 */

public class ReadIntegerAndStrings {
